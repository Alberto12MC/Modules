...
#Add module sources.
Zybo_Example_src_lib = ui.add_library("src_lib")
Zybo_Example_src_lib.add_source_files("../../../src/Zybo_Example/Zybo_Example_pkg.vhd")
Zybo_Example_src_lib.add_source_files("../../../src/Zybo_Example/Zybo_Example.vhd")
Zybo_Example_src_lib.add_source_files("../../../src/Zybo_Example/Zybo_Example_regs_pkg.vhd")
Zybo_Example_src_lib.add_source_files("../../../src/Zybo_Example/Zybo_Example_regs.vhd")

#Add tb sources.
Zybo_Example_tb_lib = ui.add_library("tb_lib")
Zybo_Example_tb_lib.add_source_files("Zybo_Example_tb.vhd")

#func checks
tb_generated = Zybo_Example_tb_lib.entity("Zybo_Example_tb")
for test in tb_generated.get_tests():
  test.add_config(name="Zybo_Example", pre_config=make_pre_check(),post_check=make_post_check())
...
if(code_coverage==True):
  Zybo_Example_src_lib.add_compile_option   ("ghdl.flags"     , ["-frelaxed-rules", "-fprofile-arcs","-ftest-coverage" ])
  Zybo_Example_tb_lib.add_compile_option("ghdl.flags"     , ["-frelaxed-rules", "-fprofile-arcs","-ftest-coverage" ])
...
if all_ok:
  if(code_coverage==True):
    subprocess.call(["lcov", "--capture", "--directory", "Zybo_Example.gcda", "--output-file",  "code_0.info" ])
